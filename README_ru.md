...
## Управление резервным копированием (Backup)

В проекте предоставлен shell-скрипт для создания логических бэкапов на уровне схем (`pg_dump`) для транзитных слоев и слоя DWH. Для выполнения резервного копирования:

_SQL-дампы будут безопасно сгенерированы и сохранены в директории `./backups`._
